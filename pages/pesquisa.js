...
const Pesquisa = () => {
  ...
  return (
    ...
    {sucess && <div className='w-1/5 mx-auto '>
      <p className='mb-6 text-center bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3'>Obrigado por contrubuir com sua sugestão ou crítica.</p>
      {
